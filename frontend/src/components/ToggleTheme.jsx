...
const ToggleTheme = () => {
  ...
  return (
    <div className="flex border justify-center items-center bg-violet w-32 gap-4">
      ...
      <Switch
        ...
        className={classNames(
          enabled ? 'bg-violet' : 'bg-light-violet',
          'relative inline-flex flex-shrink-0 h-6 w-11 border-2 rounded-full  cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet'
        )}
      >
