const Search = () => {
  return (
    <div className="container search-container mx-auto px-6 w-327 tablet:w-689 desktop:w-1110">
      {/* mobile */}
        ...
        <div className="bg-white hidden h-full dark:bg-19202D tablet:flex tablet:justify-center">
          <div className="flex justify-center h-full w-full px-4">
            <div className="basis-1/3 relative">
              ...
              <input
                id="email1"
                className="focus:outline-none bg-white font-normal w-full h-full flex items-center pl-12 text-body"
