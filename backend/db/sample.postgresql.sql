...
VALUES
  ...
  (
    ...
    "role": {
      "content": "You will work alongside a skilled team of Senior Engineers across five countries participating in system design, architecture, maintenance, and refactoring decisions. You will be working on new features and integrations and be active in code reviews and coordinating engineering efforts across teams and products.",
      "items": [
  ...
  (
    ...
    "requirements": {
      ...
      "items": [
        ...
        "Experience with EJB, J2EE,Tomcat, JBoss and relational databases such as MySQL, MSSQL, Oracle",
  ...
  (
    ...
    "apply": "coffeeroasters.com/apply",
...
-- //filter by companies or title
SELECT
  *
FROM
  dev_jobs
WHERE
  content ->> 'company' LIKE INITCAP('zx%')
  OR content ->> 'position' LIKE INITCAP('mid%');
...
FROM
  dev_jobs
WHERE
  content ->> 'location' LIKE INITCAP('united states%');
